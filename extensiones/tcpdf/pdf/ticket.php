...
$medidas = array(80,300); // Medidas en milímetros (Ancho x Alto)
        ...
        <h4>Datos de solicitud y repación</h4>
            ...
            <tr>
                <td style="background-color:white; width:140px">
                    ...
                    <br>
					    Costo: $respuestaBitacora[monto]
                        <br>
					    Abono: $respuestaBitacora[bono]
                        <br>
					    Saldo pendiente: $respuestaBitacora[saldo]
                        <br>
					    Informacion importante: $respuestaBitacora[detalleReparacion]                    
					</div>
                </td>
